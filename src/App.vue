<template>
  <div id="app">
    ...
    <footer>
      <MainFooterTop :footer-menu-items="footerMenuItems" />
      <MainFooterBottom />
    </footer>
  </div>
</template>
...
export default {
      ...
      footerMenuItems: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              anchor: 'Talent Workshops',
              url: '#',
            },
            {
              anchor: 'CPSC Certificates',
              url: '#',
            },
            {
              anchor: 'Ratings',
  ...
  computed: {
    series() {
      return JSON.parse(JSON.stringify(this.seriesListJson));
    }
  },
  components: {
    MainHeader,
